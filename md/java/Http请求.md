...
public class HttpUtils {  
	...
	public static void main(String[] args) {
		...
		String url = "http://192.167.1.6:8080/auth/boss/sysTerminal";
		String params = "info=150123001040100023B846F8A3|150123001040100023B846F8A3|九州智能机顶盒(青海)||||||||||2016-11-23 10:34:58|A";
		try {
			String s = HttpUtils.sendPost(url, params);//.doPost(url, params);
